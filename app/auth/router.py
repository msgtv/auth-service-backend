...
from app.auth.schemas import SUserRegister, SUserAuth, UsernameModel, SUserAddDB, SUserInfo, STokens, SRefreshToken
...
async def get_tokens(
    ...
    return STokens(**create_tokens(data={"sub": str(user.id)}))
...
async def process_refresh_token(
    ...
    user = await get_current_user(token=refresh_token.refresh_token, session=session)
